...
public class Write_To_Excel {
	...
	public static void main(String[] args) {
		...
		try {
			...
			FileOutputStream out = new FileOutputStream(new File((System.getProperty("user.dir") + "\\Data\\Excel\\WriteTest.xlsx")));
			workbook.write(out);
			out.close();
			System.out.println("SampleEcxcel.xlsx written successfully on disk.");
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
